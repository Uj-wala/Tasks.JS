...
// one() and three() run first because JavaScript executes synchronous code immediately in order.
// setTimeout(two, 0) is asynchronous, so two() runs last after the call stack becomes empty.
